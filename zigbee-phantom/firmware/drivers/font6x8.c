/*
 * drivers/font6x8.c — 6x8 ASCII font for SH1106 OLED
 * Author: jayis1
 * License: GPL-2.0
 *
 * Compact 6-column × 8-row (1 page) font for printable ASCII 0x20..0x7E
 * (95 glyphs). Each glyph is 6 bytes, one per column, MSB = top row.
 */
#include <stdint.h>
...
const uint8_t font6x8[][6] = {
    ...
    /* 0x26 '&' */ {0x36,0x49,0x55,0x20,0x50,0x00},
